...
namespace PartDesk.Domain.DAL.Repositories
{
    ...
    public abstract class BaseRepository<T>: IBaseRepository<T> where T : class
    {
        ...
        /// Контекст данных
        /// </summary>
        public PartDeskDataContext DataContext { get; private set; }
        ...
        protected BaseRepository(PartDeskDataContext dataContext)
        {
        ...
        /// <summary>
        /// Отсоединяет указанную сущность от слежения в контексте данных
        /// </summary>
        /// <param name="entity"></param>
